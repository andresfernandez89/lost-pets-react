		...
		<>
			{items.length === 0 ? (
				<div className="text-center">
					...
					<Link className="btn btn-primary mt-4 fw-bold" exact to="/">
					...
					<div>
						...
						<table class="table table-striped">
							...
							<tbody>
								...
								<tr className="fs-3 fw-bold">Total a pagar ${totalPrice()}</tr>
							</tbody>
						</table>
						<div className="text-center">
							...
							<Link className="btn btn-success ms-2 fw-bold " exact to="/checkout">
								Finalizar Compra
							</Link>
						</div>
					</div>
